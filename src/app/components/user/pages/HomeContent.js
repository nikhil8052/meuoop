  ...
  return (
    <>
      <div className="right-side-div">
            ...
            <div className="home-bnr-wrap">
              <div className="banner-home text-center">
                <h1 className="gradient-text">
                  {" "}
                  Inspiring UI/UX Designs <br></br> Explore the Best with Meuoop
                </h1>
                <p>
                  Explore 1,000 UI screens, 100 landing pages, and 10+ UX flows
        ...
        <section className="ux-flow-sec section section-2 second-section site-padding">
          <UxFlow />
        </section>
        ...
        <section className=" faq-sec section section-3 ">
          <FAQ />
        </section>

        <section className="foot-sec section section-3 "  style={{backgroundImage:`url('/icons/footer-bg-new.png')`}}>
          <Footer />
        </section>
      </div>
    </>
