...
import ProductCardNew  from "@/app/user/components/ProductCardNew";
        ...
        <>
             <div className="flw-tabs">
                    <div className="page-main-heading-tab d-flex ">
                      ...
                      <h2 class="gradient-text">Animations/ UI Motion</h2>  
                      </div>
                          ...
                          <div className="filters-main-div-ux mt-2">
                            <div className="ux-all-filter-wrapper">
                              ...
                              <div className="all-filters-ux d-flex flex-wrap gap-2 mb-2">
                                ...
                                <div className="badge1">Successful States</div>
                                <div className="badge1">Interactions</div>
                                <div className="badge1">Card Animations</div>
                                <div className="badge1">Splash screen</div>
                                <div className="badge1">Onboarding</div>
